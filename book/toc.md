...
[2026.09-rc1 실습 ZIP 받기](./downloads/agent-workshop-2026.09-rc1.zip) · <a href="/deepagents-handson/downloads/agent-workshop-2026.09-rc1.sha256" download>SHA256</a>
...
수업 전에 [환경 준비](./workshop/start#setup)를 마칩니다. 자료 받기부터 편집기·의존성·키 설정·첫 호출까지 안내합니다. 최초 설치 시간은 아래 일정에 포함하지 않습니다.
...
| 시간 | 학습 주제 | 직접 확인할 결과 |
|---|---|---|
|09:00–09:20|[시작 안내](./workshop/start)|실제 모델 호출과 실행 기록 확인|
...
|16:05–16:15|휴식|—|
|16:15–17:20|[A2A·ACP](./workshop/a2a)|작업 상태와 검토 산출물 구분|
|17:20–17:30|휴식|—|
|17:30–18:00|[통합·정리](./workshop/wrap)|업무 별칭을 직접 추가하고 기존 동작 유지 확인|

이 시간표는 운영 계획이며, 실제 학습 소요 시간을 검증한 결과가 아닙니다. 학습 440분·휴식 40분을 배정했습니다. 점심 60분을 포함한 체류 시간은 9시간입니다. 각 모듈은 개념 설명→함께 실습→개인 과제→풀이로 진행합니다.
