...
from .reference import (build_agent, route_inquiry, build_workflow,
                        refine_answer, build_mcp_server, accept_review)
...
def lookup_policy(topic: str) -> str:
    ...
    return json.dumps({"found": policy is not None, "topic": canonical,
