...
from .graph_lab import build_graph, route
...
def run(
    ...
    *,
    ...
    generated = draft_answer(topic, policy_tool=lookup_policy, model=model)
...
if __name__ == "__main__":
    ...
    (ROOT / "runs" / "integration.json").write_text(rendered, encoding="utf-8")
    print(rendered)
