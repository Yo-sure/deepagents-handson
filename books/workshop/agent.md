...
<details class="instructor-note"><summary>강사용 진행 노트 · 다른 연구 살펴보기</summary>
...
ReAct의 기본 흐름을 이해하는 것이 이 장의 중심입니다. 질문이 많으면 관련 연구 한 가지를 더 이야기하고, 세부 구현은 참고 링크로 안내합니다.
...
<details class="instructor-note"><summary>강사용 진행 노트 · 목표 확인</summary>

호텔 사례의 답을 한두 명에게 듣고 실제 규정 조회 기록에서 요청·결과 위치를 짚습니다. 결과가 바뀌었을 때 다음 행동도 바꿔 설명하는지 확인합니다. 새 명령을 실행하거나 연구 이름을 외우게 하지 않습니다. 도구 요청을 실행 완료로 혼동한다면 앞의 도구 호출 그림을 다시 봅니다.
