...
지금 고른 구조를 적어 두고 마지막 통합 시간에 선택이 바뀌었는지 비교합니다. 구체적인 개인 업무 데이터를 공개할 필요는 없습니다.
...
**2026.09-rc3 실습 자료**를 [ZIP으로 받습니다](../downloads/agent-workshop-2026.09-rc3.zip). 압축을 풀면 workshop 폴더가 나옵니다. 교재 웹페이지를 여는 것만으로 실습 코드가 설치되지는 않습니다. 다른 버전의 파일을 섞지 않습니다. Git을 사용하는 경우 [Git으로 받기](../git-setup)의 별도 안내를 따릅니다.
