...
자동 회귀 검사는 개발용 tests에 있습니다. 수업에서는 노트북 셀의 입력을 바꾸고 자신의 코드가 반환한 결과를 확인합니다. 자신의 코드에서 정상·추가 확인·보류가 각각 어떤 조건으로 결정되는지 확인합니다. 결과는 노트북 셀 아래에 출력됩니다. 실제 문장을 읽고 근거와 대조합니다.
