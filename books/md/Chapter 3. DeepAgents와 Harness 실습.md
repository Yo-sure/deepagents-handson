...
하네스는 그 위층입니다. 계획을 세우고, 일을 나눠 위임하고, 긴 결과를 파일로 남기는 기능을 제공합니다.</p>
</div>
...
<p class="tiny" style="margin-top:6px;color:var(--muted)">한계: 워커는 동기적입니다 — 리드는 전원이 끝날 때까지 기다리며 중간에 방향을 못 바꿉니다. 토큰을 단일 채팅의 ~15배까지 쓰므로, <strong>가치 높고 병렬 가능한 일</strong>에만 씁니다.</p>
</div></div>
</div>
